 ...
 * @author ts1sio
 */
public class AddIntervention extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddIntervention.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
