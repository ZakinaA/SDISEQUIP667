...
public class MenuSalarie extends javax.swing.JFrame {
    ...
    public MenuSalarie(Compte unCompte) {
        ...
        lePompier = PompierDAO.getPompier(cnt, unCompte.getId());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(isVolontaire == 1){
            ...
            new Profil(lePompier, leVolontaire, laProfession).setVisible(true);
        }else{
            Professionnel leProfessionnel = ProfessionnelDAO.getProfessionnel(cnt, leMatricule);
            new Profil(lePompier, leProfessionnel).setVisible(true);
        }
        this.setVisible(false);
